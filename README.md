...
- 動画を90度、180度、270度に回転
- **フリー回転**: ボタン長押しで任意の角度に回転（斜め撮影動画対応）
- **左右反転（ミラー）**: Hキーで動画を左右反転（iPhoneインカメラ動画対応）
- キーボードショートカット（Rキー / Hキー）で素早く操作
- 動画プレイヤー上のボタンで操作
...
- **回転ショートカットキー**: Rキー / Alt+R / Ctrl+Shift+R から選択
- **左右反転ショートカットキー**: Hキー / Alt+H / Ctrl+Shift+H / 無効 から選択
...
回転ボタンを**右クリック**すると、AIが動画の向きを判定して自動回転します。
